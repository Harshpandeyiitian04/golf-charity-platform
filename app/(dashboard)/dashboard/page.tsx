...
import {
    Trophy, Heart, Target, Calendar,
    TrendingUp, CheckCircle, XCircle, Clock, ChevronRight
} from 'lucide-react'
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
                            ...
                            <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-semibold mb-4 ${isActive
                            ...
                            {isActive ? (
                                ...
                                <div>
                                    ...
                                    <Link
                                        href="/pricing"
                                        className="inline-flex items-center gap-2 bg-green-500 text-black font-bold px-4 py-2 rounded-xl text-sm"
                                    >
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
                            ...
                            {charity ? (
                                ...
                                <div>
                                    ...
                                    <Link
                                        href="/charity"
                                        className="inline-flex items-center gap-2 bg-pink-500/20 text-pink-400 border border-pink-500/30 font-bold px-4 py-2 rounded-xl text-sm"
                                    >
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
                            ...
                            {scores.length > 0 ? (
                                ...
                                <div>
                                    <p className="text-gray-400 text-sm mb-4">No scores logged yet. Add your first score!</p>
                                    <Link
                                        href="/scores"
                                        className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-400 border border-blue-500/30 font-bold px-4 py-2 rounded-xl text-sm"
                                    >
